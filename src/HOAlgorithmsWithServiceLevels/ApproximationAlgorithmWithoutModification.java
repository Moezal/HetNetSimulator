 ...
 * @author mohamad
 */
public class ApproximationAlgorithmWithoutModification {
                ...
                for (int i = 0; i < peersServiceLevel.size(); i++) {
                    ...
                    if (!peersServiceLevel.get(i).isConnected() && !peersServiceLevel.get(i).isConnectionFailed()) {
                        for (int j = 0; j < peersServiceLevel.get(i).getAvailableNetworksProfitWeightRatio().size(); j++) {
                            if (peersServiceLevel.get(i).getAvailableNetworksProfitWeightRatio().get(j).getNetowrkProfitRatio().getFreeCapacity() < peersServiceLevel.get(i).getDatarate()) {
...
//                            System.out.println("the ratio is: "+peersServiceLevel.get(i).getAvailableNetworksProfitWeightRatio().get(0).getRatio());
...
//                        System.out.println("inside peerWithOneNetwork");
//                        Collections.sort(peersWithOneNetwork);
                        for (int k = 0; k < peersWithOneNetwork.size(); k++) {
                            if (peersWithOneNetwork.get(k).getPeer().getDatarate() <= peersWithOneNetwork.get(k).getNetowrkProfitRatio().getFreeCapacity()) {
...
//                                System.out.println("added peerWithOneNetwork");
                                break;
                        ...
                        for (int l = 0; l < pwr.size(); l++) {
                            if (pwr.get(l).getPeer().getDatarate() <= pwr.get(l).getNetowrkProfitRatio().getFreeCapacity()) {
