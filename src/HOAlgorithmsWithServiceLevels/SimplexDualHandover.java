 ...
 * @author mohamad
 */
public class SimplexDualHandover {
...
//            double[][] solution = GlobalOptimization.GlobalOptimizationSolverREmoveZeros.globalOptimizationParser(globalCostFunction, usersDatarate, networkCapacities);
            double[][] solution = GlobalOptimization.SimplexHODualSCP.globalOptimizationParser(globalCostFunction, usersDatarate, networkCapacities);
            Peer currentPeer;
